...
class Sae23Controller extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $con = new PDO("mysql:host=localhost;dbname=sae23", "roott", "roott");
    ...
    public function achat(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $content = "Bonjour ".$nom."<br>Votre commande a été reçu.<br>Merci<br>Eren-Commerce";
        $token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI2MTUxMyIsImlhdCI6MTY1NDg0MTY0OC44OTIxNDZ9.8kEPhMHMbaVXu0QPO9i2Ohi_88gKyyiDMMik56AFPvI";
        $number = $tel;
        $sender = "PHP";
        $recipients = [ 'value' => $number ];
